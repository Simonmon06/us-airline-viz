...
//         if (dataset && svgBarChartRef.current && dropDownRef.current) {
//             console.log('drawing!!!!')
//             const svg = d3.select(svgBarChartRef.current);
//             const dropDownSvg = d3.select(dropDownRef.current);

//             svg.selectAll("*").remove();
//             dropDownSvg.selectAll("*").remove();
...
//             dropDownSvg.select("#metric").on('change', function (e) {
//               e.preventDefault()
...
//         <select id="metric"  width="800" height="400" >
//           <option value='humidity' defaultValue>Humidity</option>
...
// TODO(if we have time) currently only shows the beginning of the animation, when select the dropdown, react have to re-render the chart.
